...
export default function Services({ services }) {
  return (
    <>
      <SEO
        title="Tree Services in Atlanta & Gwinnett County | Chavez Tree Service"
        description="Professional tree removal, tree trimming, stump grinding, land clearing, and emergency tree services in Atlanta, Lawrenceville, and Gwinnett County."
        path="/services"
      />
